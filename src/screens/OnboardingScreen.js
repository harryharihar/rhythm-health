...
export default function OnboardingScreen() {
  ...
  return (
    ...
    >
      <LinearGradient colors={['rgba(51,230,166,0.16)', 'transparent']} style={styles.ambient} pointerEvents="none" />
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Field label="Your name" value={name} onChangeText={setName} placeholder="Asha" />
        <Field label="Age" value={age} onChangeText={setAge} placeholder="28" keyboardType="number-pad" />
        <Field label="Height (cm)" value={heightCm} onChangeText={setHeightCm} placeholder="165" keyboardType="decimal-pad" />
        <Field label="Current weight (kg)" value={weightKg} onChangeText={setWeightKg} placeholder="68" keyboardType="decimal-pad" />
...
const styles = StyleSheet.create({
  ...
  mark: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(51,230,166,0.4)',
    alignItems: 'center',
